<div class="navbar">
    ...
    <div class="nav-group" id="mySidenav">
        ...
        <div class="nav-group-item">
            ...
            <a class="nav-link" href="/imtihan/dashboard/">Dashboard</a>

            <a class="nav-link" href="/imtihan/features.php">Features</a>
        
            <a class="nav-link" href="/imtihan/pricing.php">Pricing</a>

            <a class="nav-link" href="/imtihan/demo-test.php">Demo Test</a>
           
            <a class="nav-link" href="/imtihan/faqs.php">FAQs</a>

            <a class="nav-link" href="/imtihan/about.php">About Us</a>
            
            <a onclick="myFunction()" class="nav-link al-right dropbtn" title="<?php echo $admin_user_name; ?>">
                <?php echo $admin_user_name; ?></a>
      </div>
